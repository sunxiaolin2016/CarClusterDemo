...
//                    intent.setComponent(new ComponentName("com.ad.audiotest","com.ad.audiotest.MainActivity"));
...
//                    getActivity().startActivity(intent, options.toBundle());
                ...
                //    throw new IllegalStateException("Failed to report nav activity cluster launch options", e);
                //}
            }
        }
        ...
        public void onDisplayRemoved(int displayId) {
            if (mRegisteredNavDisplayId == displayId) {
                //try {
                    ...
                    //getService().setClusterActivityLaunchOptions(CATEGORY_NAVIGATION, null);
                //} catch (CarNotConnectedException e) {
    ...
    private void enforcePermission(String permission) {
        ...
        if (getActivity().checkCallingOrSelfPermission(permission) != PERMISSION_GRANTED) {
    ...
    private void enforceClusterControlPermission() {
        enforcePermission(PERMISSION_CAR_INSTRUMENT_CLUSTER_CONTROL);
    }
}
